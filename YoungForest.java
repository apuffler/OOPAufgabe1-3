...
public class YoungForest extends Forest {
    ...
    public YoungForest(int livingWoodAmount, int harvestedWoodAmount, int harvestedWoodHarvestPerYear, float harvestedWoodUsagePerYear, int deadWoodAmount, int deadWoodAdditionPerYear, float deadWoodDecayPerYear, Environment env, Economy eco){
    ...
    public void updateForest(Environment e){
        ...
        this.livingWoodAmount += ((((Math.log((double)this.livingWoodAmount * multi)) /100) + 1) * this.livingWoodAmount);
